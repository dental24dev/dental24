...
@Component({
  selector: 'app-successpatientregister',
  templateUrl: './successpatientregister.component.html',
  styleUrls: ['./successpatientregister.component.css']
})
export class SuccesspatientregisterComponent implements OnInit {
